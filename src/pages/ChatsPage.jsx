    ...
    return (
        <>
                ...
                <div className='button-wrapper'>
                    <button type = "button" id="button" className = "button"><img className = "button-image"src = {PROFILE_PICTURES_PREFIX+ "Apollo.png"}/></button>
            ...
            <div className = "bg-modal">
                <div className ="modal-content">
                    ...
                    <img className = "image-profile" src = {PROFILE_PICTURES_PREFIX+ "Apollo.png"}></img>
                    ...
                    <div className = "icon_inner">
                            ...
                            <span className = "icon_text_right">Apollo Ukrainian </span>
                        </div>
                    ...
                    <div className = "icon_inner">
                            ...
                            <span className = "icon_text_right" >+3806859781</span>
                    </div>
                    </div>
