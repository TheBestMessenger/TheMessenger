...
const UserInfo = (props) => {
  const { setUserName, setNickname, setUserPhone } = props;
  return (
    <>
      <button
        type='button'
      ...
      >
        <img className='button-image' src={props.photo} alt={'button'} />
      </button>
        ...
        <div className='modal-content'>
          ...
          <div className='icons_outer'>
            ...
            >
              ...
              <span className='icon_text_right' id='one'>
                {props.username}
              </span>
            </button>
            <button
            ...
            >
              <img
                ...
                alt={'image icon'}
              />
              <span className='icon_text_left'>Phone</span>
      ...
      <div className='editWindow3'>
        <EditProfile
          edit={true}
          editText='Change your telephone number'
          close='.editWindow3'
          setProperty={setUserPhone}
        />
      </div>
    </>
  );
